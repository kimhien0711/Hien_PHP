...
<head>
    ...
    <script>
        function resetForm() {
            ...
            document.getElementById('result').innerHTML = ''; // Xóa kết quả hiển thị
        }
    </script>
</head>
<body>
    ...
    if($kq >= 9){
        $result_message = "Học sinh Xuất Sắc";
    }else if($kq >= 8){
        $result_message = "Học sinh Giỏi";        
    }else if($kq >= 6){
        $result_message = "Học sinh Khá";      
    }else if($kq >= 5){
         $result_message = "Học sinh Trung Bình";
    }else{
        $result_message = "Học sinh Yếu";
    }
    ?>
    ...
    <div id="container">
        ...
        <form action="form_mark.php" method="POST">
            ...
            <div class="box">
                <p>Year:</p>
                <select name="year">
                    <option value="1" <?php if ($num3 == 1) echo 'selected'; ?>>1</option>
                    <option value="2" <?php if ($num3 == 2) echo 'selected'; ?>>2</option>
                </select>
            </div>
            <div class="box">
                <p>Summarise: </p>
                <input id="kq" class="input_number" type="number" value="<?php echo $kq?>" disabled>
            </div>
